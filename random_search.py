...
from cnn_mnist_solution import *
...
class MyWorker(Worker):
    ...
    def __init__(self, *args, **kwargs):
        ...
        return x_train, self.y_train, self.x_valid, self.y_valid, self.x_test, self.y_test
    ...
    def compute(self, config, budget, **kwargs):
        ...
        learning_curve, model = train_and_validate(x_train, y_train, x_valid, y_valid, epochs, lr, num_filters, batch_size, filter_sizes)      
        validation_error = sum(learning_curve)/len(learning_curve)
    ...
    def get_configspace():
        ...
        lr = CSH.UniformFloatHyperparameter("learning_rate", lower=1e-3, upper=1e-1, default_value='1e-2', log=True)
        num_filters = CSH.UniformFloatHyperparameter("num_filters", lower=8, upper=256, default_value='8', log=True)
        ...
        config_space.add_hyperparameters([lr, num_filters, batch_size, filter_size])
